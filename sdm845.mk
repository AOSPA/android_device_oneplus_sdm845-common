...
PRODUCT_COPY_FILES += \
    ...
    $(LOCAL_PATH)/configs/android.hardware.graphics.composer@2.3-service.rc:$(TARGET_OUT_PRODUCT)/vendor_overlay/$(PRODUCT_TARGET_VNDK_VERSION)/android.hardware.graphics.composer@2.3-service.rc
